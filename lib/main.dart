  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          useMaterial3: true,
          colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 75, 75, 255)),
        ),
        home: MyHomePage(),
      ),
    );
...
class GeneratorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final superstyle = theme.textTheme.headlineSmall!.copyWith(color: theme.colorScheme.onPrimary);
          ...
          for (var i in ind.entries)
            Padding(
              ...
              child: ListTile(
                ...
                title: Text(i.value[0], style: superstyle),
                subtitle: Text(i.value[1], style: substyle),
                leading: Text(i.key, style: leadstyle),
                trailing: Icon(Icons.info, color: theme.colorScheme.onPrimary),
